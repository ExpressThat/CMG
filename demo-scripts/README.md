...
- `149-gif-pointer-choreography.cmgscript`: Demonstrates GIF pointer duration, speed, easing, click pulses, click/navigation/assertion holds, parent block defaults, and child drag overrides.
