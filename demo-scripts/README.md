...
- `41-locator-filters.cmgscript`: Demonstrates exact text, regex text, role/name, `first=`, `nth=`, `has=`, `hasNot=`, `hasText=`, `hasNotText=`, `visible=`, `or=`, and `and=` locators with pointer-aware actions.
