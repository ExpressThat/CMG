...
- Shared actions include pointer-aware browser actions, browser contexts, worker control, coverage collection, page-error capture, storage state, API requests, network fetch mocks, fixtures and file assertions, PDF output, file upload, tab/popup controls, and visual assertions.
