...
- Shared actions include pointer-aware browser actions, storage state, API requests, network fetch mocks, fixtures and file assertions, PDF output, file upload, tab/popup controls, and visual assertions.
