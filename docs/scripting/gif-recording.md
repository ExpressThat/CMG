...
- Pointer actions that accept element offsets, such as `click "<selector>" x=8 y=12`, move the virtual pointer to the same element-relative point that receives the browser event.
