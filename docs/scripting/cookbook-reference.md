# `.cmgscript` Cookbook Reference

Runnable demo scripts live in [`../../demo-scripts/`](../../demo-scripts/).

This page is the full pattern catalogue. If you are learning CMG for the first time, start with the [top-level README](../../README.md), [guided examples](examples.md), [scripting guide](index.md), and [style guide](style-guide.md), then come back here for specific patterns.
