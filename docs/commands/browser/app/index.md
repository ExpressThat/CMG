...
- Successful launch or attach writes the selected Chrome or Edge state slot. Later `browser control`, `browser control script`, `cmg run`, GIF recording, traces, and reports use that app target.
