# `browser control assertions toBeNotChecked`

Playwright-style alias for [`expectNotChecked`](expectNotChecked.md).

```powershell
cmg browser control assertions toBeNotChecked "<selector>" [--timeout <milliseconds>]
```
...
```text
PASS 001 toBeNotChecked #marketing
