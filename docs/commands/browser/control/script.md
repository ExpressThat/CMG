...
- Supports the same parity actions as the structured runner DSL, including `apiRequest`, `storageState`, `newContext`, `useContext`, `closeContext`, `intercept`, `readFile`, `fixture`, `writeFile`, `appendFile`, `expectFile`, `printPdf`, `uploadFiles`, `expectScreenshot`, `openTab`, and `waitForTab`.
...
CONTEXT_ACTIVE 032 ...
CONTEXT_CLOSED 033 ...
FILE_READ 034 payload C:\Projects\CMG\fixtures\payload.json
FILE_WRITTEN 035 C:\Projects\CMG\demo-output\result.txt
FILE_APPENDED 036 C:\Projects\CMG\demo-output\result.txt
FILE_OK 037 C:\Projects\CMG\demo-output\result.txt
PDF 038 C:\Projects\CMG\demo-output\page.pdf
