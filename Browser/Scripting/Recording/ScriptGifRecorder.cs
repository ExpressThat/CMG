...
public sealed partial class ScriptGifRecorder : IDisposable
{
    ...
    public void BeforeAction(BrowserScriptAction action)
    {
        ...
        if (name is "click" or "dblclick" or "rightclick" or "tap" or "touchtap" or "download" or "type" or "fill" or "clear" or
    ...
    public void AfterAction(BrowserScriptAction action)
    {
        ...
        if (name is "click" or "dblclick" or "rightclick" or "tap" or "touchtap" or "download" or "frameclick")
        {
            CapturePulseFrame();
            CaptureHoldFrame();
            return;
