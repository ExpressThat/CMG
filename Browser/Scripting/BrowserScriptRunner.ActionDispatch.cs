...
public sealed partial class BrowserScriptRunner
{
        ...
        ScriptGifRecorder? recorder)
    {
        ...
        return action.Name.ToLowerInvariant() switch
        {
            ...
            "listconsole" => ExecuteListConsole(remoteDebuggingUrl, automationClient, action),
            ...
            "listpageerrors" => ExecuteListPageErrors(remoteDebuggingUrl, automationClient, action),
            ...
            "step" or "narrate" or "macro" or "call" or "return" or "within" or "frame" or "framelocator" or "recording" or "withrecording" or "recordingdefaults" or "showkeystrokes" or "showmousebuttons" or "shownetworkactivity" or "showconsoleactivity" or
