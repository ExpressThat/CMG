...
public sealed partial class CmgVisualSegmentExecutor
{
    ...
    private CmgScriptBatchRun RunLines(
        ...
        CMG.Browser.Scripting.Recording.GifEncodingOptions? gifEncoding = null,
        CMG.Browser.Scripting.Recording.GifRedactionOptions? gifRedaction = null,
        CMG.Browser.Scripting.Recording.GifAccessibilityOptions? gifAccessibility = null)
    {
        if (lines.Count is 0)
        {
