...
public sealed partial class CmgActionLowerer
{
    public IReadOnlyList<string> Lower(CmgNode action)
    {
        ...
        return name switch
        {
            ...
            "expectinviewport" or "tobeinviewport" or "expectnotinviewport" or "tobenotinviewport" =>
            ...
            "unchecked" or "expectunchecked" or "tobeunchecked" or "expectnotchecked" or "tobenotchecked" =>
                CmgExpectationScripts.Element(action with { Kind = ToExpectationName(name) }, "unchecked"),
            ...
            "textcontent" or "innertext" or "inputvalue" or "getattribute" or "computedstyle" or "property" or "count" or "locatorcount" or "boundingbox" or "alltextcontents" or "allinnertexts" =>
                [ToLine(action.Kind, action.Arguments, action.Options)],
            "set" => LowerSet(action),
            ...
            "pausegif" or "recordcheckpoint" or "gifsnapshot" or "gif.snapshot" or "setrecording" or "previewrecordingsettings" or "pointerstyle" or "recordvariable" or "intro" or "outro" or "maskgif" or "redactgif" or "redacttext" or "unmaskgif" or "unredactgif" or
