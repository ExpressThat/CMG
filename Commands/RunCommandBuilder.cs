...
public sealed partial class RunCommandBuilder
{
    public Command Build(BrowserSelectionOptions browserOptions)
    {
        ...
        var gifOption = new Option<DirectoryInfo?>("--gif") { Description = "Write per-test visual recordings to this directory." }; var noGifOption = new Option<bool>("--no-gif") { Description = "Disable command-level and script-block GIF recording." }; gifOption.Aliases.Add("-gif");
        var gifQualityOption = new Option<string>("--gif-quality")
        {
            Description = "Recording quality for --gif: archival, highest, high, medium, or low.",
