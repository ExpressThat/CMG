...
public sealed partial class BrowserControlCommandBuilder
{
    private Command BuildScriptCommand(BrowserSelectionOptions browserOptions)
    {
        ...
        var command = new Command("script", "Run a .cmgscript browser automation script.")
        {
            ...
            encodingOptions.Crop, encodingOptions.CropPadding, encodingOptions.SmartCrop, encodingOptions.Scale, encodingOptions.MaxWidth, encodingOptions.MaxHeight, encodingOptions.Viewport, encodingOptions.PixelRatio, encodingOptions.SafeArea, encodingOptions.LayoutStability, encodingOptions.Debug, encodingOptions.Accessibility, encodingOptions.EventCaptions,
